...
public class PlayerViewHolder<T extends Player>
        extends BaseViewHolder<T>{

    @BindView(R.id.card_player_cutout)
    ImageView playerCutoutImageView;
    @BindView(R.id.card_player_name)
    TextView playerNameTextView;
    @BindView(R.id.card_player_nationality)
    TextView playerNationalityTextView;
    @BindView(R.id.card_player_position)
    TextView playerPositionTextView;
    @BindView(R.id.card_player_height)
    TextView playerHeightTextView;
    @BindView(R.id.card_player_weight)
    TextView playerWeightTextView;
    @BindView(R.id.card_player_birthday)
    TextView playerDateBornTextView;
