...
public class LeagueTablePresenter extends BasePresenter<LeagueTableFragment>{
    ...
    public void onCreate(Bundle savedState){
        ...
        restartableLatestCache(REQUEST_LEAGUE_TABLE,() -> api.getLeagueTable(leagueId,season).subscribeOn(Schedulers.io()).observeOn(mainThread()),LeagueTableFragment::onTable,LeagueTableFragment::onNetworkError);
    }

    protected void request(String leagueId){
        this.leagueId = leagueId; start(REQUEST_LEAGUE_TABLE);
    }
}
