...
public class LeaguesPresenter extends BasePresenter<SoccerLeaguesActivity>{
    ...
    public void onCreate(Bundle savedState){
        ...
        restartableLatestCache(REQUEST_SOCCER_LEAGUES,() -> api.getLeagues().subscribeOn(Schedulers.io()).observeOn(Schedulers.computation()).map(leagues -> localData.writeLeaguesToRealm(leagues)).observeOn(mainThread()),SoccerLeaguesActivity::onLeagues,SoccerLeaguesActivity::onNetworkError);
