...
public class NextEventsFragment extends BaseFragment<Event,NextEventsPresenter>{
    ...
    public void onViewCreated(View view,Bundle bundle){
        setAdapter(new SimpleListAdapter<>(R.layout.progress_bar,new ClassViewHolderType<>(Event.class,R.layout.card_next_event,v -> new NextEventViewHolder<>(v,this::onItemClick))));
    ...
    protected void onEvents(@Nullable List<Event> list){
        if(isNullOrEmpty(list)) displayError(R.string.next_events_fragment_error_message,R.drawable.ic_error_fragment_next_events);
